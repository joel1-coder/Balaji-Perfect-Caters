...
const navItems = [
 ...
 { label: 'Menu Items', path: '/user/menu' },
];
...
const styles = {
 ...
 navItem: { display: 'flex', alignItems: 'center', gap: '8px', padding: '11px 12px', borderRadius: '8px', border: 'none', backgroundColor: 'transparent', color: 'rgba(255,255,255,0.55)', cursor: 'pointer', fontSize: '0.9rem', width: '100%', textAlign: 'left', fontFamily: "'Outfit', sans-serif", fontWeight: '500', transition: '0.15s' },
