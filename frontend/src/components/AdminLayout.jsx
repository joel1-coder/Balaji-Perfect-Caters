...
const navItems = [
  { icon: 'ðŸ“Š', label: 'Executive Overview', path: '/admin/overview' },
  { icon: 'ðŸ½ï¸', label: 'Menu Management',    path: '/admin/menu-items' },
  { icon: 'ðŸ“ˆ', label: 'Transaction Audit',  path: '/admin/audit' },
  { icon: 'ðŸ‘¥', label: 'Staff Management',   path: '/admin/staff' },
  { icon: 'ðŸ“', label: 'Catering Quotation', path: '/admin/quotation' },
];

const INITIAL_NOTIFICATIONS = [
  { id: 1, icon: 'ðŸ’³', title: 'New Transaction', message: 'BB5119 â€” â‚¹305.00 marked as PAID', time: '2 min ago', read: false },
  { id: 2, icon: 'âš ï¸', title: 'Unpaid Order Alert', message: 'BB4627 â€” â‚¹305.00 is still UNPAID', time: '18 min ago', read: false },
  { id: 3, icon: 'ðŸ‘¤', title: 'New Staff Added', message: 'Rahul Sharma (EMP-9421) added to roster', time: '1 hr ago', read: false },
  { id: 4, icon: 'ðŸ½ï¸', title: 'Menu Updated', message: 'Veg Biryani price changed to â‚¹80', time: '3 hrs ago', read: true },
  { id: 5, icon: 'âœ…', title: 'Order Cleared', message: 'BB2295 â€” â‚¹320.00 cleared successfully', time: 'Yesterday', read: true },
];
              ...
              {showNotif && (
                <div style={s.dropdown}>
                  <div style={s.dropHeader}>
                    <span style={s.dropTitle}>ðŸ”” Notifications</span>
                    {unreadCount > 0 && (
...
const s = {
  ...
  // Notification Bell
  bellBtn: { position: 'relative', width: '40px', height: '40px', borderRadius: '10px', border: '1px solid #E8DED1', backgroundColor: 'white', cursor: 'pointer', fontSize: '1.1rem', display: 'flex', alignItems: 'center', justifyContent: 'center' },
  ...
  notifIconWrap:{ fontSize: '1.2rem', width: '36px', height: '36px', borderRadius: '8px', backgroundColor: '#F4EFE7', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 },
