        ...
        <div style={s.kpiRow}>
          <div style={{ ...s.kpiCard, borderTop: '4px solid #E3A23B' }}>
            <div style={s.kpiHeader}>
              ...
              <span style={s.kpiIconBox}>â‚¹</span>
            </div>
            <div style={s.kpiValue}>â‚¹3,248.50</div>
            <div style={s.kpiTrend}><span style={{ color: '#9C6B22' }}>â†‘ +8.4%</span> vs last week</div>
          </div>
          <div style={{ ...s.kpiCard, borderTop: '4px solid #F2C36B' }}>
            ...
            <div style={s.kpiTrend}><span style={{ color: '#9C6B22' }}>â†‘ +12.1%</span> vs last week</div>
          </div>
          <div style={{ ...s.kpiCard, borderTop: '4px solid #E3A23B' }}>
            <div style={s.kpiHeader}>
            ...
            <div style={s.kpiValue}>â‚¹7.88</div>
        ...
        <div style={s.bottomGrid}>
          ...
          <div style={s.listCard}>
            ...
            <div style={s.listCont}>
              {[
                { name: 'Grilled Chicken Salad', units: 142, revenue: 'â‚¹1,136.00', trend: '+12%', color: '#FFF3D5' },
                { name: 'Fresh Orange Juice', units: 98, revenue: 'â‚¹490.00', trend: '+5%', color: '#FFF3D5' },
                { name: 'Espresso Double', units: 85, revenue: 'â‚¹340.00', trend: '+2%', color: '#FFF3D5' },
                { name: 'Avocado Toast', units: 76, revenue: 'â‚¹646.00', trend: '-3%', color: '#dcfce7' },
              ].map((item, i) => (
