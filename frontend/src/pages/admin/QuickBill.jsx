...
const s = {
  topBar: { display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '14px 24px', backgroundColor: 'white', borderBottom: '1px solid #e2e8f0' },
  topBarLeft: { display: 'flex', alignItems: 'center', gap: '12px' },
  pageTitle: { fontSize: '1.3rem', fontWeight: '800', color: '#0f2444' },
  ...
  searchBox: { display: 'flex', alignItems: 'center', gap: '8px', backgroundColor: '#f8fafc', border: '1px solid #e2e8f0', borderRadius: '10px', padding: '8px 14px' },
  searchInput: { border: 'none', backgroundColor: 'transparent', outline: 'none', color: '#64748b', fontSize: '0.9rem', width: '160px', fontFamily: "'Outfit', sans-serif" },
  iconBtn: { width: '36px', height: '36px', border: '1px solid #e2e8f0', borderRadius: '8px', backgroundColor: 'white', cursor: 'pointer', fontSize: '1rem' },
  userBadge: { display: 'flex', alignItems: 'center', gap: '10px', cursor: 'pointer' },
  userAvatar: { width: '34px', height: '34px', borderRadius: '50%', backgroundColor: '#0f2444', color: 'white', display: 'flex', alignItems: 'center', justifyContent: 'center', fontWeight: '800', fontSize: '0.9rem' },
  userName: { fontSize: '0.85rem', fontWeight: '700', color: '#0f172a', textTransform: 'capitalize' },
  userRole: { fontSize: '0.7rem', color: '#64748b' },
  contentArea: { display: 'flex', flex: 1, gap: '20px', padding: '20px', overflow: 'auto', fontFamily: "'Outfit', sans-serif", backgroundColor: '#f1f5f9' },
  orderPanel: { flex: 1, display: 'flex', flexDirection: 'column', gap: '16px' },
  card: { backgroundColor: 'white', borderRadius: '12px', padding: '20px', boxShadow: '0 1px 3px rgba(0,0,0,0.06)', border: '1px solid #e2e8f0' },
  cardTitle: { fontSize: '0.85rem', fontWeight: '800', color: '#475569', textTransform: 'uppercase', letterSpacing: '0.5px', display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '16px' },
  selectionRow: { display: 'flex', alignItems: 'flex-end', gap: '14px', flexWrap: 'wrap' },
  selectWrapper: { flex: 2, minWidth: '200px' },
  fieldLabel: { display: 'block', fontSize: '0.75rem', color: '#64748b', marginBottom: '6px' },
  select: { width: '100%', padding: '10px 14px', border: '1.5px solid #e2e8f0', borderRadius: '8px', fontSize: '0.95rem', color: '#0f172a', backgroundColor: 'white', outline: 'none', fontFamily: "'Outfit', sans-serif" },
  qtyControl: { display: 'flex', alignItems: 'center', gap: '10px', border: '1.5px solid #e2e8f0', borderRadius: '8px', padding: '6px 14px' },
  qtyBtn: { width: '28px', height: '28px', backgroundColor: '#f1f5f9', border: 'none', borderRadius: '6px', fontSize: '1.1rem', cursor: 'pointer', fontWeight: '700', color: '#374151' },
  qtyValue: { minWidth: '30px', textAlign: 'center', fontSize: '1rem', fontWeight: '700' },
  rateBox: { padding: '10px 18px', border: '1.5px solid #e2e8f0', borderRadius: '8px', fontSize: '1rem', fontWeight: '700', color: '#0f172a' },
  addBtn: { padding: '10px 20px', backgroundColor: '#0f2444', color: 'white', border: 'none', borderRadius: '8px', fontWeight: '800', cursor: 'pointer', fontSize: '0.9rem', whiteSpace: 'nowrap', fontFamily: "'Outfit', sans-serif" },
  ...
  th: { fontSize: '0.75rem', color: '#94a3b8', textTransform: 'uppercase', fontWeight: '700', padding: '8px 12px', textAlign: 'left', borderBottom: '1px solid #f1f5f9' },
  tr: { borderBottom: '1px solid #f8fafc' },
  td: { padding: '12px', color: '#374151', fontSize: '0.9rem', verticalAlign: 'middle' },
  removeBtn: { backgroundColor: 'transparent', border: 'none', color: '#ef4444', cursor: 'pointer', fontSize: '1rem', fontWeight: '700' },
  
  bottomBar: { backgroundColor: '#0f172a', display: 'flex', alignItems: 'center', padding: '20px 30px', borderBottomLeftRadius: '12px', borderBottomRightRadius: '12px', marginTop: 'auto', gap: '30px' },
  totalUnitsBox: { color: 'white', borderRight: '1px solid rgba(255,255,255,0.1)', paddingRight: '30px' },
  unitsLabel: { fontSize: '0.7rem', fontWeight: '700', color: '#94a3b8', marginBottom: '4px' },
  ...
  statusDisplayBtn: { padding: '12px 24px', backgroundColor: 'white', border: 'none', borderRadius: '8px', color: '#0f172a', fontWeight: '700', cursor: 'default' },
  saveOrderBtn: { padding: '12px 30px', backgroundColor: '#bfdbfe', border: 'none', borderRadius: '8px', color: '#1e3a8a', fontWeight: '800', cursor: 'pointer', display: 'flex', alignItems: 'center', boxShadow: '0 4px 6px -1px rgba(0,0,0,0.1)' },
  
  totalRow: { display: 'flex', justifyContent: 'flex-end', gap: '24px', marginTop: '16px', paddingTop: '16px', borderTop: '2px solid #f1f5f9' },
  totalLabel: { fontWeight: '700', color: '#64748b' },
  totalValue: { fontWeight: '800', color: '#0f2444', fontSize: '1.1rem' },
  ...
  sectionLabel: { fontSize: '0.75rem', fontWeight: '800', color: '#64748b', textTransform: 'uppercase', letterSpacing: '0.5px' },
  editBtn: { backgroundColor: 'transparent', border: 'none', cursor: 'pointer', color: '#64748b', fontSize: '1rem' },
  memberCard: { display: 'flex', gap: '10px', alignItems: 'center', marginBottom: '14px', padding: '10px', backgroundColor: '#f8fafc', borderRadius: '10px' },
  memberAvatar: { width: '40px', height: '40px', borderRadius: '8px', backgroundColor: '#1a3a6b', color: 'white', display: 'flex', alignItems: 'center', justifyContent: 'center', fontWeight: '800', fontSize: '0.85rem' },
  memberName: { fontWeight: '700', fontSize: '0.9rem', color: '#0f172a' },
  memberId: { fontSize: '0.75rem', color: '#64748b' },
  memberMeta: { display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '10px', marginBottom: '14px' },
  metaLabel: { fontSize: '0.7rem', color: '#94a3b8', textTransform: 'uppercase', letterSpacing: '0.5px', marginBottom: '4px' },
  metaValue: { fontSize: '0.85rem', color: '#374151', fontWeight: '600' },
  paymentRow: { display: 'flex', justifyContent: 'space-between', alignItems: 'center' },
  paymentToggle: { display: 'flex', gap: '6px' },
  payBtn: { padding: '4px 10px', borderRadius: '6px', border: '1px solid #e2e8f0', backgroundColor: '#f8fafc', color: '#94a3b8', cursor: 'pointer', fontSize: '0.7rem', fontWeight: '700' },
  ...
  txCard: { display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '10px', backgroundColor: '#f8fafc', borderRadius: '10px' },
  txId: { fontSize: '0.8rem', fontWeight: '700', color: '#0f172a' },
  txTime: { fontSize: '0.7rem', color: '#94a3b8' },
  txAmount: { fontSize: '0.9rem', fontWeight: '800', color: '#0f2444' },
  ...
  modalTitle: { fontSize: '1.1rem', fontWeight: '800', color: '#0f2444' },
  closeBtn: { background: 'none', border: 'none', fontSize: '1.2rem', cursor: 'pointer', color: '#94a3b8' },
  modalBody: { display: 'flex', flexDirection: 'column', gap: '16px' },
  field: { display: 'flex', flexDirection: 'column', gap: '6px' },
  input: { padding: '10px 14px', border: '1.5px solid #e2e8f0', borderRadius: '8px', fontSize: '0.95rem', outline: 'none', fontFamily: "'Outfit', sans-serif" },
  modalFooter: { display: 'flex', gap: '12px', justifyContent: 'flex-end', marginTop: '24px' },
  cancelBtn: { padding: '10px 20px', borderRadius: '8px', border: '1px solid #e2e8f0', backgroundColor: 'white', color: '#64748b', fontWeight: '600', cursor: 'pointer' },
  saveBtn: { padding: '10px 20px', borderRadius: '8px', border: 'none', backgroundColor: '#0f2444', color: 'white', fontWeight: '700', cursor: 'pointer' },
};
