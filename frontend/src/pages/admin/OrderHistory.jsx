...
const ORDERS = [
 { id: '#ORD-94021', date: '2024-05-24', time: '10:45 AM', customer: 'John Doe', initials: 'JD', color: '#FFF3D5', items: 'Grilled Chicken Salad, Fresh Orange Juice...', total: 24.50, status: 'Paid' },
 { id: '#ORD-94020', date: '2024-05-24', time: '10:42 AM', customer: 'Alice Smith', initials: 'AS', color: '#FFF3D5', items: 'Espresso, Avocado Toast', total: 18.20, status: 'Unpaid' },
 { id: '#ORD-94019', date: '2024-05-23', time: '10:30 AM', customer: 'Guest #102', initials: '', color: '#F4EFE7', items: 'Double Cheeseburger Combo, Large Soda', total: 15.75, status: 'Paid' },
 ...
 { id: '#ORD-94017', date: '2024-04-02', time: '09:00 AM', customer: 'Emma Watson', initials: 'EW', color: '#FFF3D5', items: 'Pancakes, Maple Syrup, Black Coffee', total: 21.00, status: 'Paid' },
...
const OrderHistory = () => {
 ...
 <h1 style="color: #7A0008; border-bottom: 2px solid #7A0008; padding-bottom: 10px;">Order History Report</h1>
 ...
 filteredOrders.forEach(o => {
 docContent += `
 <div style="margin-bottom: 15px; padding: 10px; border: 1px solid #ccc; background: #FAF7F2;">
 ...
 <p><strong>Total:</strong> Rs. ${o.total.toFixed(2)}</p>
 ...
 <button style={s.iconBtn}>Alerts</button>
 ...
 <div style={s.totalVal}>Rs. {totalFilteredSales.toFixed(2)}</div>
 </div>
 </div>
 ...
 <td style={{...s.td, fontWeight: '700', color: '#5A0006' }}>{o.id}</td>
 <td style={s.td}>
 <div style={{ fontWeight: '600', color: '#4A3D38', fontSize: '0.9rem' }}>{o.date}</div>
 <div style={{ color: '#8D7E73', fontSize: '0.75rem' }}>{o.time}</div>
 </td>
 <td style={s.td}>
 ...
 <td style={{...s.td, color: '#5E514A', maxWidth: '200px' }}>{o.items}</td>
 <td style={{...s.td, fontWeight: '700' }}>Rs. {o.total.toFixed(2)}</td>
 <td style={s.td}>
 ...
 <div style={{ color: '#7A0008', fontWeight: '700', marginBottom: '12px' }}>12:00 PM - 1:30 PM.</div>
 <div style={s.progressBar}><div style={{...s.progressFill, width: '75%' }}></div></div>
 </div>
 <div style={s.summaryCard}>
 <div style={s.summaryTitle}>Top Selling Item</div>
 <div style={{ color: '#7A0008', fontWeight: '700', fontSize: '1.1rem', margin: '8px 0' }}>Grilled Chicken Salad</div>
 <div style={{ color: '#6F6259', fontSize: '0.85rem' }}>142 units sold</div>
 </div>
 <div style={s.summaryCard}>
 ...
 <div key={p.label}>
 <div style={{ fontSize: '0.75rem', color: '#8D7E73' }}>{p.label}</div>
 <div style={{ fontWeight: '800', color: '#5A0006' }}>{p.val}</div>
 </div>
 ))}
 </div>
 </div>
...
const s = {
 ...
 searchInput: { border: 'none', backgroundColor: 'transparent', outline: 'none', fontSize: '0.9rem', color: '#6F6259', width: '220px', fontFamily: "'Outfit', sans-serif" },
 iconBtn: { width: '36px', height: '36px', border: '1px solid #E8DED1', borderRadius: '8px', backgroundColor: 'white', cursor: 'pointer' },
 newOrderBtn: { backgroundColor: '#7A0008', color: 'white', border: 'none', borderRadius: '10px', padding: '10px 18px', fontWeight: '700', cursor: 'pointer', fontSize: '0.9rem', fontFamily: "'Outfit', sans-serif" },
 page: { flex: 1, padding: '24px', overflow: 'auto', display: 'flex', flexDirection: 'column', gap: '20px', fontFamily: "'Outfit', sans-serif" },
 card: { backgroundColor: 'white', borderRadius: '14px', padding: '24px', border: '1px solid #E8DED1', boxShadow: '0 1px 4px rgba(0,0,0,0.06)' },
 ...
 dateLabel: { fontSize: '0.75rem', fontWeight: '700', color: '#8D7E73', textTransform: 'uppercase', letterSpacing: '0.5px' },
 dateInput: { padding: '9px 12px', border: '1px solid #E8DED1', borderRadius: '8px', fontFamily: "'Outfit', sans-serif", fontSize: '0.9rem', outline: 'none', color: '#5A0006' },
 clearBtn: { padding: '9px 16px', backgroundColor: '#F4EFE7', color: '#6F6259', border: 'none', borderRadius: '8px', fontWeight: '600', cursor: 'pointer', fontFamily: "'Outfit', sans-serif", height: '38px' },

 exportContainer: { display: 'flex', alignItems: 'center', gap: '12px' },
 exportLabel: { color: '#8D7E73', fontSize: '0.8rem', textTransform: 'uppercase', fontWeight: '700', letterSpacing: '0.5px' },
 exportBtn: { background: 'none', border: 'none', color: '#7A0008', fontWeight: '700', cursor: 'pointer', fontSize: '0.9rem', fontFamily: "'Outfit', sans-serif", padding: '8px 12px', backgroundColor: '#FAF7F2', borderRadius: '8px' },

 totalSalesCard: { backgroundColor: '#7A0008', color: 'white', borderRadius: '12px', padding: '12px 20px', textAlign: 'right' },
 ...
 td: { padding: '18px 14px', color: '#4A3D38', fontSize: '0.9rem', verticalAlign: 'middle' },
 customerCell: { display: 'flex', alignItems: 'center', gap: '10px' },
 avatar: { width: '32px', height: '32px', borderRadius: '8px', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '0.75rem', fontWeight: '800', color: '#4A3D38', flexShrink: 0 },
 badge: { fontSize: '0.78rem', fontWeight: '700', padding: '4px 12px', borderRadius: '20px' },
 
 paginationRow: { display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginTop: '20px', paddingTop: '16px', borderTop: '1px solid #F4EFE7' },
 showingText: { color: '#8D7E73', fontSize: '0.85rem' },
 pagination: { display: 'flex', gap: '6px' },
 pageBtn: { width: '34px', height: '34px', border: '1px solid #E8DED1', borderRadius: '8px', backgroundColor: 'white', cursor: 'pointer', fontSize: '0.9rem', fontFamily: "'Outfit', sans-serif" },
 pageActive: { width: '34px', height: '34px', border: '1px solid #7A0008', borderRadius: '8px', backgroundColor: '#7A0008', color: 'white', cursor: 'pointer', fontSize: '0.9rem', fontFamily: "'Outfit', sans-serif", fontWeight: '700' },
 ...
 summaryTitle: { fontWeight: '700', color: '#5A0006', marginBottom: '8px' },
 summaryText: { color: '#6F6259', fontSize: '0.85rem' },
 progressBar: { height: '6px', backgroundColor: '#E8DED1', borderRadius: '10px' },
 progressFill: { height: '100%', backgroundColor: '#7A0008', borderRadius: '10px' },
